...
It includes `gpu\_verticles.pml` -- generated 3d-model verticles definition, `gpu_triangles.pml` -- 3d-model triangles setup, `gpu_trigo.pml` -- pre-calculated cine/cosine in fixed-point integers. 
